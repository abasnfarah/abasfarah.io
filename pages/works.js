      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        <Section>
          <WorkGridItem
            id="raeda"
            title="Raeda"
            thumbnail={thumbRaeda}
            link={'https://github.com/abasnfarah/Tennis-Self-Serve/tree/main'}
          >
            An AI powered mobile application to coach tennis players using
            computer vision and a bluetooth wristband to capture motion data.
          </WorkGridItem>
        </Section>
        <Section>
          <WorkGridItem
            id="cuda"
            title="Cuda Algorithms"
            thumbnail={thumbCuda}
            link={'https://github.com/mutegalaxy/cuda'}
          >
        ...
        <Section>
          <WorkGridItem
            id="ezylendz"
            title="EzyLendz"
            thumbnail={thumbEzylendz}
            link={'https://github.com/abasnfarah/ezylends'}
          >
        ...
        <Section>
          <WorkGridItem
            id="dotfiles"
            title="Dotfiles"
            thumbnail={thumbDotfiles}
            link={'https://github.com/abasnfarah/${id}'}
          >
